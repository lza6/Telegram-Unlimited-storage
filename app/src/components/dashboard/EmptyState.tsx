...
export function EmptyState({ onUpload, uploadEnabled = true, blockedTitle, variant = 'folder' }: EmptyStateProps) {
    ...
    if (variant === 'search') {
        ...
        return (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
                ...
                <p className="text-telegram-subtext text-sm max-w-xs">

                    Try a different search term, or clear search to browse the current folder.
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
            ...
            <p className="text-telegram-subtext text-sm mb-6 max-w-xs">
                ...
                Drag files from your desktop to upload, use the toolbar Upload button, or click below.
            ...
            <button
                ...
                title={!uploadEnabled ? blockedTitle : undefined}

                className="inline-flex items-center gap-2 px-6 py-3 bg-telegram-primary text-black font-medium rounded-xl hover:bg-telegram-primary/90 transition-all hover:scale-105 shadow-lg shadow-telegram-primary/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
