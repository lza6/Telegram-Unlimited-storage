...
Primary references: [Bot API](https://core.telegram.org/bots/api), [Bot FAQ](https://core.telegram.org/bots/faq), [MTProto file API](https://core.telegram.org/api/files), [RPC errors](https://core.telegram.org/api/errors), [Local Bot API server](https://github.com/tdlib/telegram-bot-api), [Bot API Range decision](https://github.com/tdlib/telegram-bot-api/issues/141), [2 GB bot boundary](https://github.com/tdlib/telegram-bot-api/issues/583), [Grammers repository](https://github.com/Lonami/grammers).
